...
public class TwPutbackAction extends TwAction {
	TwTransactionPanel transactionPanel = new TwTransactionPanel(
			TwTransactionPanel.PUTBACK);

	/** Creates new TwPutbackAction */
	public TwPutbackAction() {
		super("Putback ..");
		setType(TwResources.TW_PUTBACK_ACTION);
		twActionDialog = new TwActionDialog(new javax.swing.JFrame(), true);
		twActionDialog.setTitle("Teamware:Putback");
	...
	public void performDialogAction() {
		...
		while ((outputLine = command.getOutputLine()) != null) {
			...
			twActionDialog.setStatusMsg("Putback ..");
