...
/**
 * TwCommand executes the command line for transaction etc It allows to execute
 * the command line and returns the status of execution and output and error
 * messages associated with the execution
 */
public class TwCommand {
	...
	/**
	 * Execute the command line in a separate thread The command parameter is a
	 * fully qualified path of the command
	 */
	...
	/**
	 * Prints debug info about the command line process like output,error &
	 * return status
	 */
	public void print() {
		String line = null;
		System.out
				.println("------------------------------  TwCommand Print  -----------------------");
